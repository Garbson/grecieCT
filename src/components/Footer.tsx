      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-bold mb-4 text-white">Complexo do Alemão</h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 justify-center">
                ...
                <span className="text-gray-200">R. Uruguai, 2995 - Embratel, Porto Velho - RO, 76820-884</span>
              </li>
              <li className="flex items-center gap-2 justify-center">
                <Phone size={20} className="shrink-0" />
                <a href="tel:+5569993030072" className="text-gray-200 hover:text-white transition-colors">(69) 99303-0072</a>
              </li>
              <li className="flex items-center gap-2 justify-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-center md:text-left">© {currentYear} Complexo do Alemão - Todos os direitos reservados.</p>
          <div className="mt-4 md:mt-0 text-center md:text-right">
            <p className="text-gray-300">
             Site desenvolvido por <span className="font-semibold">Garbson Souza</span>
            </p>
            <a href="https://wa.me/5569993030072" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors text-sm flex items-center justify-center md:justify-end gap-1 mt-1">
